...
<head>
                    ...
                    <div class="col-xl-10">
                      <div class="card-body p-md-8 text-black">
                        ...
                        <form method="POST" onsubmit="return validarFormulario()">
                          ...
                          include "../../Controlador/ConRegistroVenta.php";
                          ?>
  ...
  <script>
    ...
    function validarFormulario(){
      ...
      const porcIva = document.getElementById('iva').value.trim();
      ...
      const añoVenta = ahora.getFullYear(); // Año con cuatro dígitos
