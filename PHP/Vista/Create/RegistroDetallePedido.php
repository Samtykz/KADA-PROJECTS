	...
	<div class="container">
		<div class="row">
			<div class="col-6"style="margin: 0 auto">
                ...
                <?php
                    include "../../Modelo/Conexion.php";
                    include "../../Controlador/ConRegistroDetallePedido.php";
                ?>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-labblacel">ID del Producto Pedido</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-labblacel">Cantidad Producto Pedido</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-labblacel">Precio unitario</label>
                        <input type="number" id="preUni" class="form-control" name="precioUnidad">
                        <!--<div class="form-text">Ingresa el Precio Por Unidad del Producto.</div>-->
                        <br>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-labblacel">Subtotal</label>
                        <input type="number" id="subt" class="form-control" name="subtotal">
                        <!--div class="form-text">Ingresa el Subtotal.</div>-->
                        <br>
                        <span id="errorSub" class=" text-danger"></span>
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-labblacel">ID del Pedido</label>
                        <input type="number" id="idPed" class="form-control" name="Ped_id">
                        <!--<div class="form-text">Ingresa el ID del Pedido.</div>-->
                        <br>
    ...
    <script>
        ...
        function limpiarError(campoId, errorId) {
          ...
          // Limpiar errores al escribir en cada campo
            ...
            limpiarError('metPago', 'errorIdPed');
            limpiarError('subt', 'errorSub');
            limpiarError('idPed', 'errorMetodo');
    </script>
</body>
</html>