...
<head>
  ...
  <script>
    ...
    const regexDocumento = /^\d{9}$/; // Para números de 10 dígitos
    ...
    console.log("Validando formulario...");
        ...
        // Validar proveedor (asumiendo que es un teléfono)
        if (proveedorNuevo && !regexDocumento.test(proveedorNuevo)) {
            errores.push("El proveedor debe tener exactamente 10 dígitos.");
        }
