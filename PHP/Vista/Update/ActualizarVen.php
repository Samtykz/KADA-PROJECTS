                ...
                <form method="POST" id="formActualizarVenta">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <input type="number" name="total_venta" class="form-control form-control-lg" value="<?php echo $venta["vent_total"]; ?>" readonly>
                      <label class="form-label">Total a Pagar</label>
                    </div>
                    <div class="col-md-6 mb-4">
                      <input type="number" id="totNuevo" name="total_venta" class="form-control form-control-lg">
                      <label class="form-text">Igresa el valor nuevo</label>
                    </div>
                  </div>

                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <input type="number" class="form-control" name="Ped_id" value="<?php echo $venta["id_Pedido_FK"]; ?>" readonly>
                    ...
                    <div class="col-md-6 mb-4">
                      ...
                      <label class="form-text"> Ingresa el ID del Pedido</label>
                    </div>
                  </div>
