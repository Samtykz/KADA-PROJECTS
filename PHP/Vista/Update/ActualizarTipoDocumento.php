                ...
                <form method="POST" id="formActualizarTipoDocumento">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                      <div data-mdb-input-init class="form-outline">
                        ...
                        <label class="form-label" for="nomNuevo">
                          <div id="emailHelp" class="form-text">Ingresa el nombre del tipo de documento nuevo.</div>
                        </label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex justify-content-end pt-3">
                    <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-light btn-lg">
                      <a href="../Read/viTipoDocumento.php" style="text-decoration: none; color:#f5eef8">Cancelar</a>
                    </button>
                    <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-secondary btn-lg ms-2" name="actualizar">
                      <span style="text-decoration: none; color:#f5eef8">Actualizar</span>
                    </button>
                  </div>
                  <?php
                  ?>
