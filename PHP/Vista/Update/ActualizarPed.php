                      ...
                      <div class="card-body p-md-8 text-black">
                          <form id="formActualizarPedido" method="POST">
                            <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Modificar Pedido</p>
                              ...
                              <?php
                              include  "../../Controlador/ActualizarPedido.php";
                              ?>

                              <div class="row">
                                <div class="col-md-6 mb-4">
                                  <div data-mdb-input-init class="form-outline">
                                    <input type="number" class="form-control" name="docClie" value="<?php echo $pedido["clie_Documento_FK"]; ?>" readonly>
                                ...
                                <div class="col-md-6 mb-4">
                                  <div data-mdb-input-init class="form-outline">
                                    ...
                                    <label class="form-text" >Ingresa el nuevo documento del Cliente</label>
                                  </div>
                                </div>
                              </div>
