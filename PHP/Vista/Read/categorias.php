    ...
    <table class="table table-hover" style="text-align: center; max-width: 95%;">
      <thead>
        <tr>
          ...
          <th scope="col"><a href="../Create/CrearCategoria.php" class="agregate" title="Crear" data-toggle="tooltip"><i class="material-icons" style="margin: 5px; color: #ec7063;"><svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="35px" fill="#52be80"><path d="M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160Zm40 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg></i></a></th>
        </tr>
      </thead>
      <tbody>
        <?php
        ...
        $sql = $conexion->query("SELECT * FROM productocategoria");
        
        while($datos = $sql->fetch_object()){?>
          <tr>
            <td><?=$datos->id_Categoria_PK?></td>
            <td><?=$datos->nombreCategoria?></td>
            <td>
              
              <a href="../Update/ActualizarCategoria.php?id=<?= $datos->id_Categoria_PK?>" class="edit" title="Editar" data-toggle="tooltip">
                <i class="material-icons" style="margin: 5px; color: #f4d03f;">&#xE254;</i></a>
              </a>
              <a onclick="return eliminar()" href="../Read/categorias.php?id=<?= $datos->id_Categoria_PK?>" class="delete" title="Eliminar" data-toggle="tooltip">
