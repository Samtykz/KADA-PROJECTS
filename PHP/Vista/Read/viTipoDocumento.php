...
<script>
    function eliminar(){
      var respuesta=confirm("¿Estás seguro de inactivar este Tipo de Documento? Si lo eliminas, eliminas los datos relacionados a él");
      return respuesta
    }
</script>
    ...
    <table class="table table-hover" style="text-align: center; max-width: 95%;">
      <thead>
        <tr>
          ...
          <th scope="col"><a href="../Create/RegistroTipoDocumento.php" class="agregate" title="Crear" data-toggle="tooltip">
      ...
      <tbody>
        ...
        <tr>
          <td><?=$datos->id_TipoDocumento_PK?></td>
          <td><?=$datos->nombreDocumento?></td>
          <td style="display: flex; justify-content: center;">
            <a href="../Update/ActualizarTipoDocumento.php?id=<?= $datos->id_TipoDocumento_PK?>" class="edit" title="Actualizar" data-toggle="tooltip"><i class="material-icons" style="margin: 5px; color: #f4d03f;">&#xE254;</i></a>
            <a onclick="return eliminar()" href="../Read/viTipoDocumento.php?id=<?= $datos->id_TipoDocumento_PK?>" class="delete" title="Eliminar" data-toggle="tooltip">
